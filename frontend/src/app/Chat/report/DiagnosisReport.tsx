              ...
              <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                <div className="px-4 py-4">
                  <div className="space-y-2">
                    {diagnosisResult.lifestyleChanges.map(
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
                            <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                              ...
                              <ul className="space-y-1">
                                {med.pros.map((pro: string, i: number) => (
                                  <li
                                    key={i}
                            ...
                            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                              ...
                              <ul className="space-y-1">
                                {med.cons.map((con: string, i: number) => (
                                  <li
                                    key={i}
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            {diagnosisResult.dangerSigns?.length > 0 && (
              <div className="bg-red-50 border-2 border-red-200 rounded-xl overflow-hidden">
                ...
                <div className="px-4 py-4">
                  <div className="space-y-2">
                    {diagnosisResult.dangerSigns.map(
