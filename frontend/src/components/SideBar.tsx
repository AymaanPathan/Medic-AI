...
const Sidebar = () => {
  ...
  const ChatItem = ({ chat }: { chat: Ichat }) => (
    <div
      className={`group ${
        chat.thread_id === activeChat
          ? "bg-[#303030] text-white  rounded-3xl"
          : ""
      } relative p-2 cursor-pointer transition-all duration-200 rounded-lg mb-1.5 `}
  ...
  return (
    <div className="flex flex-col mt-16   border-r">
      {/* Header - stays fixed */}
